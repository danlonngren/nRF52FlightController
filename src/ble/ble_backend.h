...
/************************************************************************/
                                        //0A 6E D3 B9 - 74 74 - 47 FD - 86 17 - 94 C0 FF 37 7A 40
#define CUSTOM_SERVICE_UUID_BASE       {0x40, 0x7A, 0x37, 0xFF, 0xC0, 0x04,\
                                          0x17, 0x86, \
                                          0xFD, 0x47, \
                                          0x74, 0x74, \
                                          0xB1, 0xD3, \
                                          0x6E, 0x40}
#define CUSTOM_SERVICE_UUID             0xD3B1
#define CUSTOM_CHAR_UUID                0xD3B2
...
#define DEVICE_NAME                     "Scheduler"                       /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME               "And8n"                   /**< Manufacturer. Will be passed to Device Information Service. */
