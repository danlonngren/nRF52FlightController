...
// Bit start <<  3
#define MPU6050_GYRO_FS_250    0x00 // SSF: 131 
#define MPU6050_GYRO_FS_500    0x01 // SSF: 65.5
#define MPU6050_GYRO_FS_1000   0x02 // SSF: 32.8
#define MPU6050_GYRO_FS_2000   0x03 // SSF: 16.4
